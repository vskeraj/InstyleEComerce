...
const PaymentForm = () => {
    ...
    const handelPaymentForm: SubmitHandler<PaymentFormInputs> = (data) => {
    ...
    return (
        <form className="flex flex-col gap-4" onSubmit={handleSubmit(handelPaymentForm)}>
            ...
            <div className='flex flex-col gap-1'>
                <label className="text-xs text-gray-500 font-medium">Expiration Date</label>
                <input className="border-b border-gray-200 py-2 outline-none text-sm"
                    type="text"
                    placeholder="01/32"
            ...
            <button type="submit" className="w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white p-2 rounded-lg flex items-center justify-center gap-2">
                Checkout
